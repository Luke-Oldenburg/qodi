...
//  Qodi New
//
//  Created by Miyaz Ansari on 8/6/23.
//
...
struct Home: View {
    @State var selectedTab = "barcode.viewfinder" // Replace with your default tab
                ...
                ForEach(tabs, id: \.self) { image in
                    GeometryReader { reader in
                        Button(action: {
                            ...
                            Image(systemName: image) // Use SF Symbol name here
                                .resizable()
...
var tabs = ["bookmark.fill", "barcode.viewfinder", "person.circle"] // Use SF Symbol names here
